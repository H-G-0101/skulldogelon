...
{for(var i = 0, len = gdjs.TitleCode.GDFadeObjectObjects2.length ;i < len;++i) {
    gdjs.TitleCode.GDFadeObjectObjects2[i].getBehavior("Resizable").setWidth(gdjs.evtTools.camera.getCameraWidth(runtimeScene, "", 0));
}
}
{for(var i = 0, len = gdjs.TitleCode.GDFadeObjectObjects2.length ;i < len;++i) {
    gdjs.TitleCode.GDFadeObjectObjects2[i].getBehavior("Resizable").setHeight(gdjs.evtTools.camera.getCameraHeight(runtimeScene, "", 0));
}
}
}
...
isConditionTrue_0 = false;
{
isConditionTrue_1 = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, runtimeScene.getGame().getVariables().getFromIndex(2).getAsString(), null);
...
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuExitObjects4.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuExitObjects4[i].getVariableString(gdjs.TitleCode.GDBitmapMenuExitObjects4[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Up").getAsString() ) {
        isConditionTrue_0 = true;
        gdjs.TitleCode.GDBitmapMenuExitObjects4[k] = gdjs.TitleCode.GDBitmapMenuExitObjects4[i];
        ++k;
    }
}
gdjs.TitleCode.GDBitmapMenuExitObjects4.length = k;
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuCreditsObjects4.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuCreditsObjects4[i].getVariableString(gdjs.TitleCode.GDBitmapMenuCreditsObjects4[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Up").getAsString() ) {
        isConditionTrue_0 = true;
        gdjs.TitleCode.GDBitmapMenuCreditsObjects4[k] = gdjs.TitleCode.GDBitmapMenuCreditsObjects4[i];
        ++k;
    }
}
gdjs.TitleCode.GDBitmapMenuCreditsObjects4.length = k;
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuStartObjects4.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuStartObjects4[i].getVariableString(gdjs.TitleCode.GDBitmapMenuStartObjects4[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Up").getAsString() ) {
        isConditionTrue_0 = true;
...
isConditionTrue_0 = false;
{
isConditionTrue_1 = gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, runtimeScene.getGame().getVariables().getFromIndex(3).getAsString(), null);
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
}
...
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuExitObjects3.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuExitObjects3[i].getVariableString(gdjs.TitleCode.GDBitmapMenuExitObjects3[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Down").getAsString() ) {
        isConditionTrue_0 = true;
        gdjs.TitleCode.GDBitmapMenuExitObjects3[k] = gdjs.TitleCode.GDBitmapMenuExitObjects3[i];
        ++k;
    }
}
gdjs.TitleCode.GDBitmapMenuExitObjects3.length = k;
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuCreditsObjects3.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuCreditsObjects3[i].getVariableString(gdjs.TitleCode.GDBitmapMenuCreditsObjects3[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Down").getAsString() ) {
        isConditionTrue_0 = true;
        gdjs.TitleCode.GDBitmapMenuCreditsObjects3[k] = gdjs.TitleCode.GDBitmapMenuCreditsObjects3[i];
        ++k;
    }
}
gdjs.TitleCode.GDBitmapMenuCreditsObjects3.length = k;
for (var i = 0, k = 0, l = gdjs.TitleCode.GDBitmapMenuStartObjects3.length;i<l;++i) {
    if ( gdjs.TitleCode.GDBitmapMenuStartObjects3[i].getVariableString(gdjs.TitleCode.GDBitmapMenuStartObjects3[i].getVariables().get("ID")) == runtimeScene.getScene().getVariables().getFromIndex(1).getChild("Down").getAsString() ) {
        isConditionTrue_0 = true;
...
};gdjs.TitleCode.mapOfGDgdjs_9546TitleCode_9546GDMenuSelectorObjects2Objects = Hashtable.newFrom({"MenuSelector": gdjs.TitleCode.GDMenuSelectorObjects2});
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = !(gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, runtimeScene.getGame().getVariables().getFromIndex(2).getAsString(), null));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = !(gdjs.evtsExt__Gamepads__C_Button_pressed.func(runtimeScene, 1, runtimeScene.getGame().getVariables().getFromIndex(3).getAsString(), null));
if (isConditionTrue_0) {
isConditionTrue_0 = false;
...
};gdjs.TitleCode.mapOfGDgdjs_9546TitleCode_9546GDMenuSelectorObjects1Objects = Hashtable.newFrom({"MenuSelector": gdjs.TitleCode.GDMenuSelectorObjects1});
